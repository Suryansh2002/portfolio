...
export function SendMessage({setPollIn, email}:{setPollIn: Dispatch<SetStateAction<number>>, email?:string}){
    ...
    return <form className="w-full flex justify-center gap-2 absolute bottom-4 left-0 right-0 px-4" onSubmit={submit}>
        <textarea className="flex flex-1 ml-2 bg-slate-900 text-white text-xl rounded-3xl pt-1 border-blue-700 border-2 shadow-[0px_0px_6px_rgba(150,150,250)] px-5 py-2 no-scrollbar" name="text" id="text"></textarea>
